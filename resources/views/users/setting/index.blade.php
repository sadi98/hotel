        ...
        <div class="settings-wrapper py-3">
            ...
            <div class="card settings-card">
                <div class="card-body">
                    ...
                    <div class="single-settings d-flex align-items-center justify-content-between">
                        ...
                        <div class="data-content"><a href="language.html">English<i class="lni lni-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card settings-card">
                <div class="card-body">
                    ...
                    <div class="single-settings d-flex align-items-center justify-content-between">
                        ...
                        <div class="data-content"><a href="support.html">Get Help<i class="lni lni-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card settings-card">
                <div class="card-body">
                    ...
                    <div class="single-settings d-flex align-items-center justify-content-between">
                        ...
                        <div class="data-content"><a href="privacy-policy.html">View<i
            ...
            <div class="card settings-card">
                <div class="card-body">
                    <!-- Single Settings-->
                    <div class="single-settings d-flex align-items-center justify-content-between">
                        <div class="title"><i class="lni lni-lock"></i><span>Password<span>Updated 1 month
                                    ago</span></span></div>
                        <div class="data-content"><a href="change-password.html">Change<i
                                    class="lni lni-chevron-right"></i></a></div>
                    </div>
                </div>
            </div>
