...
@section('content')
            ...
            <div class="flash-sale-slide owl-carousel">
                ...
                <div class="card flash-sale-card">
                    <div class="card-body"><a href="single-product.html"><img
                                src="{{ asset('users/img/product/1.png') }}" alt=""><span
                ...
                <div class="card flash-sale-card">
                    <div class="card-body"><a href="single-product.html"><img
                                src="{{ asset('users/img/product/2.png') }}" alt=""><span
                ...
                <div class="card flash-sale-card">
                    <div class="card-body"><a href="single-product.html"><img
                                src="{{ asset('users/img/product/3.png') }}" alt=""><span
                    ...
                    <div class="card product-card">
                        <div class="card-body">
                            ...
                            <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                    class="mb-2" src="{{ asset('users/img/product/11.png') }}" alt="">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card product-card">
                        <div class="card-body">
                            ...
                            <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                    class="mb-2" src="{{ asset('users/img/product/5.png') }}" alt=""></a>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card product-card">
                        <div class="card-body">
                            ...
                            <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                    class="mb-2" src="{{ asset('users/img/product/6.png') }}" alt=""></a>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card product-card">
                        <div class="card-body">
                            ...
                            <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                    class="mb-2" src="{{ asset('users/img/product/9.png') }}" alt="">
                                <!-- Offer Countdown Timer: Please use event time this format: YYYY/MM/DD hh:mm:ss -->
                                <ul class="offer-countdown-timer d-flex align-items-center shadow-sm"
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card product-card">
                        <div class="card-body">
                            ...
                            <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                    class="mb-2" src="{{ asset('users/img/product/8.png') }}" alt=""></a>
                            <!-- Product Title --><a class="product-title d-block" href="single-product.html">Wooden
                                Chair</a>
                            <!-- Product Price -->
                    ...
                    <div class="card product-card">
                        <div class="card-body">
                            ...
                            <!-- Wishlist Button--><a class="wishlist-btn" href="#"><i
                                    class="lni lni-heart"></i></a>
                            <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                    class="mb-2" src="{{ asset('users/img/product/4.png') }}" alt=""></a>
    ...
    <div class="cta-area">
        <div class="container">
            <div class="cta-text p-4 p-lg-5" style="background-image: url('{{ asset('users/img/bg-img/24.jpg') }}')">
                        ...
                        <div class="card-body d-flex align-items-center">
                            <div class="product-thumbnail-side">
                                ...
                                <!-- Wishlist Button --><a class="wishlist-btn" href="#"><i
                                        class="lni lni-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        src="{{ asset('users/img/product/10.png') }}" alt=""></a>
                            </div>
                        ...
                        <div class="card-body d-flex align-items-center">
                            <div class="product-thumbnail-side">
                                ...
                                <!-- Wishlist Button --><a class="wishlist-btn" href="#"><i
                                        class="lni lni-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        src="{{ asset('users/img/product/7.png') }}" alt=""></a>
                            </div>
                            <div class="product-description">
                                <!-- Product Title --><a class="product-title d-block" href="single-product.html">Office
                                    Chair</a>
                                <!-- Price -->
                        ...
                        <div class="card-body d-flex align-items-center">
                            <div class="product-thumbnail-side">
                                ...
                                <!-- Wishlist Button --><a class="wishlist-btn" href="#"><i
                                        class="lni lni-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        src="{{ asset('users/img/product/12.png') }}" alt="">
                                    <!-- Offer Countdown Timer: Please use event time this format: YYYY/MM/DD hh:mm:ss -->
                                    <ul class="offer-countdown-timer d-flex align-items-center shadow-sm"
                        ...
                        <div class="card-body d-flex align-items-center">
                            <div class="product-thumbnail-side">
                                ...
                                <!-- Wishlist Button --><a class="wishlist-btn" href="#"><i
                                        class="lni lni-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        src="{{ asset('users/img/product/13.png') }}" alt=""></a>
                            </div>
                            <div class="product-description">
        ...
        <div class="card discount-coupon-card">
            <div class="card-body">
                <div class="coupon-text-wrap d-flex align-items-center p-3">
                    ...
                    <p class="text-white ps-3 mb-0">To get discount, enter the<strong class="px-1">GET20</strong>code on
                        the checkout page.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="product-thumbnail-side">
                                <!-- Wishlist Button --><a class="wishlist-btn shadow-sm border" href="#"><i
                                        class="lni lni-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        src="{{ asset('users/img/product/14.png') }}" alt=""></a>
                            </div>
                            <div class="product-description">
                        ...
                        <div class="card-body">
                            ...
                            <div class="product-thumbnail-side">
                                <!-- Wishlist Button --><a class="wishlist-btn shadow-sm border" href="#"><i
                                        class="lni lni-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        src="{{ asset('users/img/product/15.png') }}" alt=""></a>
                            </div>
                            <div class="product-description">
                                <!-- Product Title --><a class="product-title d-block" href="single-product.html">Travel
                                    Bag</a>
                                <!-- Price -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="product-thumbnail-side">
                                <!-- Wishlist Button --><a class="wishlist-btn shadow-sm border" href="#"><i
                                        class="lni lni-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        src="{{ asset('users/img/product/16.png') }}" alt=""></a>
                            </div>
                            <div class="product-description">
                                <!-- Product Title --><a class="product-title d-block" href="single-product.html">Cotton
                                    T-shirts</a>
                                <!-- Price -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="product-thumbnail-side">
                                <!-- Wishlist Button --><a class="wishlist-btn shadow-sm border" href="#"><i
                                        class="lni lni-heart"></i></a>
                                <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html"><img
                                        src="{{ asset('users/img/product/6.png') }}" alt=""></a>
                            </div>
                            <div class="product-description">
                                <!-- Product Title --><a class="product-title d-block" href="single-product.html">Roof
                                    Lamp</a>
