                ...
                <div class="card-body h-100 p-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 col-xxl-12 text-center"><img class="img-fluid"
                                src="{{ asset('admin/assets/img/illustrations/at-work.svg') }}" style="max-width: 26rem" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-header">
                    ...
                    <div class="dropdown no-caret">
                        ...
                        <div class="dropdown-menu dropdown-menu-end animated--fade-in-up"
                            ...
                            <a class="dropdown-item" href="#!">
                                <div class="dropdown-item-icon"><i class="text-gray-500" data-feather="plus-circle"></i>
                                </div>
                                Add New Task
                            </a>
                            <a class="dropdown-item" href="#!">
                                <div class="dropdown-item-icon"><i class="text-gray-500" data-feather="minus-circle"></i>
                                </div>
                                Delete Tasks
                            </a>
                        </div>
